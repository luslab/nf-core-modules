...
include { R } from '../../../software/r/main.nf' addParams(script: analysis_scripts.r_test)
...
--------------------------------------------------------------------------------------*/
test_data = [
    [[id:"sample1"], "https://raw.githubusercontent.com/luslab/nf-core-test-data/main/data/metadata/10x_test.csv"]
] 
