...
include {
    ASSERT_CHANNEL_COUNT as ASSERT_CHANNEL_COUNT_CUT;
...
include { PARACLU_CUT } from '../../../../modules/paraclu/cut/main.nf'
...
workflow {
    ...
    ASSERT_CHANNEL_COUNT_VERSION( PARACLU_CUT.out.versions, "PARACLU_VERSIONS", 2 )
