...
include { CROSSLINKS_NORMCOVERAGE } from '../../../../modules/crosslinks/normcoverage/main.nf'
...
workflow {
    ...
    ASSERT_CHANNEL_COUNT_VERSION( CROSSLINKS_NORMCOVERAGE.out.versions, "CROSSLINKS_VERSIONS", 2 )
